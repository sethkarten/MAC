...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mappo', choices=["r_mappo_comm", "t_mappo_comm", "r_mappo", "mappo", "macppo", "memo_ppo"])
    ...
    parser.add_argument("--user_name", type=str, default='milkkarten',help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    # use autoencoder
    parser.add_argument("--vae", action='store_true', default=False, help='ground communication in autoencoder')
    ...
    parser.add_argument("--env_size", type=int, default=32, help='size of adaptive sampling env')
    ...
    parser.add_argument("--gif_dir", type=str, default=None, help="by default None. set the path to save gif.")
