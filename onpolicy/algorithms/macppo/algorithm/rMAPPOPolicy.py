import torch
from onpolicy.algorithms.macppo.algorithm.r_actor_critic import MAC_R_Actor, R_Critic
...
class R_MAPPOPolicy:
    ...
    def __init__(self, args, obs_space, cent_obs_space, act_space, device=torch.device("cpu")):
        ...
        self.actor = MAC_R_Actor(args, self.obs_space, self.act_space, self.device)
        print(self.actor)
    ...
    def evaluate_actions(self, cent_obs, obs, rnn_states_actor, rnn_states_critic, action, masks,
        ...
        # _, _, contrast_rand_loss, contrast_future_loss = self.actor.critic(obs, rnn_states_critic, masks, r_obs=r_obs, f_obs=f_obs)
