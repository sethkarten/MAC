...
class R_MAPPO_COMM():
    ...
    :param policy: (T_MAPPO_Policy) policy to update.
    ...
    def ppo_update(self, sample, update_actor=True):
        ...
        if update_actor:
            ...
            actor_loss = policy_loss - dist_entropy * self.entropy_coef + ae_loss + contrast_rand_loss + contrast_future_loss
            actor_loss.backward()
        ...
        # # critic update
        value_loss, _, _ = self.cal_value_loss(values, value_preds_batch, return_batch, active_masks_batch)
