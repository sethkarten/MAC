...
from onpolicy.envs.pascal_voc.pascal_voc_env import PascalVocEnv
...
def make_train_env(all_args):
    def get_env_fn(rank):
        def init_env():
            if all_args.env_name == "PascalVoc":
                env = PascalVocEnv(all_args)
            else:
...
def parse_args(args, parser):
    env = parser.add_argument_group('Pascal VOC task')
...
def main(args):
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.pascal_voc_runner import PascalVocRunner as Runner
    else:
        from onpolicy.runner.separated.pascal_voc_runner import PascalVocRunner as Runner
