...
from onpolicy.envs.mnist.mnist import MNISTMemorizationEnv
...
def make_train_env(all_args):
    def get_env_fn(rank):
        def init_env():
            if all_args.env_name == "MNISTMemorization":
                env = MNISTMemorizationEnv(all_args)
            else:
...
def main(args):
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.mnist_runner import MNISTRunner as Runner
    else:
        raise NotImplementedError
