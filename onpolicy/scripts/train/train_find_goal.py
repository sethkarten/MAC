...
from onpolicy.envs.marl_grid.find_goal.envs.environments import make_environment
from onpolicy.envs.env_wrappers import ShareSubprocVecEnv, ShareDummyVecEnv
from onpolicy.envs.marl_grid.find_goal import config
...
def main(args):
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.find_goal_runner import FindGoalRunner as Runner
    else:
        from onpolicy.runner.separated.find_goal_runner import FindGoalRunner as Runner
